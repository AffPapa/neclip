...
@section('description', 'NeClip — бесплатный нативный менеджер буфера обмена и сниппетов для Apple Silicon Mac. История, поиск, исправление EN/RU и автовставка. Локально, без аккаунта, облака и телеметрии. Open source.')
@section('canonical', 'https://affpapa.org/neclip')

@php
    $version = '1.3.0';
    $dmgUrl = 'https://github.com/AffPapa/neclip/releases/download/v1.3.0/NeClip-1.3.0.dmg';
    ...
    $faqs = [
        ...
        ['q' => 'Как вставить без форматирования?', 'a' => 'Выберите запись клавишами и нажмите Shift+Return — вставится чистый текст без форматирования. Обычный Return сохраняет доступное форматирование.'],
    ...
    $changelog = [
        [
            ...
            'items' => [
                'Компактное menu-bar меню без значка в Dock: история, поиск, закрепление и разделы сниппетов',
                'Ручное и выключенное по умолчанию автоматическое исправление EN/RU-раскладки',
                'Понятные разрешения macOS без необходимости добавлять NeClip кнопкой «+»',
                'Swift 6, нативные глобальные горячие клавиши и GRDB 7.10.0',
                'Developer ID, нотарификация Apple, stapling и Gatekeeper-проверка точного DMG',
            ],
        ],
        [
            'ver' => '1.1.1',
    ...
    <section class="hero" id="top">
        <div class="nc-hero-grid">
            <div>
                ...
                <p class="nc-dl-meta">NeClip-{{ $version }}.dmg · 2.3 MB · подписано и нотарифицировано · MIT</p>
            </div>
