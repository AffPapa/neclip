...
Current public release: **2.7.2 / build 44**. The exact signed artifact,
source commit and release checks are recorded in
[RELEASE-2.7.2-STATUS.md](RELEASE-2.7.2-STATUS.md).
...
Only `v2.7.2` is supported publicly. Its download URL, SHA-256 and build number
