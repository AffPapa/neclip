...
Current public release: **2.7.3 / build 45**. The exact signed artifact,
source commit and release checks are recorded in
[RELEASE-2.7.3-STATUS.md](RELEASE-2.7.3-STATUS.md).
...
Only `v2.7.3` is supported publicly. Its download URL, SHA-256 and build number
