...
Current public release: **2.8.0 / build 46**. The exact signed artifact,
source commit and release checks are recorded in
[RELEASE-2.8.0-STATUS.md](RELEASE-2.8.0-STATUS.md).
...
Only `v2.8.0` is supported publicly. Its download URL, SHA-256 and build number
