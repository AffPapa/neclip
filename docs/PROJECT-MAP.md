...
Current public release: **2.5.6 / build 35**. The exact signed artifact,
source commit and release checks are recorded in
[RELEASE-2.5.6-STATUS.md](RELEASE-2.5.6-STATUS.md).
...
Only `v2.5.6` is supported publicly. Its download URL, SHA-256 and build number
