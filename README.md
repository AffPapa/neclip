...
Current public, signed and notarized version: **2.5.4 (build 33)**,
...
[Download the signed and notarized NeClip 2.5.4 DMG](https://github.com/AffPapa/neclip/releases/download/v2.5.4/NeClip-2.5.4.dmg)
(2,042,306 bytes).
SHA-256:
