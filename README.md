...
Current public, signed and notarized version: **2.5.2 (build 31)**,
...
Its [release evidence](docs/RELEASE-2.5.2-STATUS.md) and
...
[Download the signed and notarized NeClip 2.5.2 DMG](https://github.com/AffPapa/neclip/releases/download/v2.5.2/NeClip-2.5.2.dmg)
(2,042,307 bytes).
SHA-256:
